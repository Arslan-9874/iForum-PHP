                        ...
                        <form action="partials/__handleContact.php" method="post">
                            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="fullname" name="fullname" maxlength="255" value=""
                                        required>
                                </div>
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" maxlength="255" value=""
                                            required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
